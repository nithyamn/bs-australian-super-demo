...
public class InvestmentsTest extends BrowserStackRunner {
    @Test
    public void test() throws Exception{
        ...
        /** Navigating to Australian Super's Investments page **/
        ...
        if(title.contains("Superannuation Investments | AustralianSuper")) {
